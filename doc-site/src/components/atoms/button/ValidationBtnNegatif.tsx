...
const ValidationBtnNegatif: React.FC<ButtonProps> = ({ children, className, ...props }) => {
  ...
  return (
    <button
      ...
      className={`bg-white px-5 ${className ?? ""}`}
    ...
    <span className="relative z-10 select-none">
      {/* <H4Title className="text-center text-primary font-bold">{children}</H4Title> */}

       <H4Title className="text-center text-primary font-bold 4k-screen:hidden">{children}</H4Title>
        <PContent className="text-center text-primary font-bold hidden 4k-screen:block">{children}</PContent>
...
export default ValidationBtnNegatif;
