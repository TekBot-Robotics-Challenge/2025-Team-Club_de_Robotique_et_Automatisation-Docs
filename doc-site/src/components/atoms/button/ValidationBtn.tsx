...
const ValidationBtn: React.FC<ButtonProps> = ({ children, className, ...props }) => {
  ...
  return (
    <button
      ...
      className={`bg-primary px-5 ${className ?? ""}`}
    ...
    >
      <span className="select-none">
        <H4Title className="text-center text-white font-bold 4k-screen:hidden">{children}</H4Title>
        <PContent className="text-center text-white font-bold hidden 4k-screen:block">{children}</PContent>
